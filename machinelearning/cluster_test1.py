...
infile = '20150814_security_tender_data.csv'
outfile = 'cluster_output.csv'
docids = []
descriptions = []
years = []
...
stopwords.extend(['tender','tenders','require','required','requires','invite','supply','supplier','invited','deliver','delivery','provide','provides','provided','contract','contractor','services','service','services','including','public','council','councils','management','business','provision','maintenance'])
